...
def LGBM_training(data, n_class):
    ...
    model = LGBMClassifier(objective='multi:softprob', num_class=n_class, learning_rate=0.06, use_label_encoder=False)
...
def LGBM_prediction(data, model):
